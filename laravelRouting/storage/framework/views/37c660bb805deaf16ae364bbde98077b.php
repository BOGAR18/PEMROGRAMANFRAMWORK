    ...
    <div class="container py-2 px-4">
        ...
        <div class="offcanvas offcanvas-end bg-purple" id="offcanvasNavbar">
            ...
            <div class="offcanvas-body pt-0 px-4">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    <li class="nav-item col-6 col-md-auto"><a href="#" class="nav-link active">Item</a></li>
                </ul>
                <ul class="navbar-nav flex-row flex-wrap">
                ...
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="dropdown" data-bs-theme="light">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><button class="dropdown-item active bg-purple"
                                    type="button"> <small>Latest (5.3.x) <i class="bi-check"></i></small></button></li>
                    ...
                    <li class="nav-item">
                        ...
                        <i class="bi-brightness-high-fill"></i><span class="d-lg-none">Toogle theme</span></button>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><button class="dropdown-item active bg-purple" type="button"><small>
                                <i class="bi-brightness-high-fill me-2"></i>Light</small></button></li>
                            <li><button class="dropdown-item active bg-purple" type="button"><small>
                                <i class="bi-brightness-high-fill me-2"></i>Dark</small></button></li>
                            <li><button class="dropdown-item active bg-purple" type="button"><small>
                                <i class="bi-brightness-high-fill me-2"></i>Auto</small></button></li>
                        </ul>
                        </div>
                    </li>
                </ul>
...
Bootstrap </h1>
        <p class="fs-5 mt-3">Quickly design and custonize responsive
mobile-first sites with Bootstrap, the world's most popular front-end open source toolkit, featuring Sass varlables and mixins, responsive grid systen, extensive prebuilt components, and powerful JavaScript plugins. </p>
        <div class="row">
            <div class="d-flex flex-column flex-md-row">
                <button type="button" class="btn bg-purple text-white
btn-lg mb-3 me-nd-3 px-4 py-3">Get Started </button>
                <button type="button" class="btn btn-outline-dark btn-1g
...
themes from the <a href="#">official Bootstrap Themes marketplace</a>. Themes are built on Bootstrap as their own extended frameworks, rich with new components and plugins, documentation,
and powerful build tools</p>
    ...
    docs <a href="#" class="text-black">CC BY 3.0</a>.</small>
            ...
            <div class="col-6 col-1g-2 offset-1g-1 mb-5">
            <h5>Links</h5>
...
<?php /**PATH C:\Users\SATRIO TEGAR\Desktop\laravelRouting\resources\views/cloningbootstrap.blade.php ENDPATH**/ ?>